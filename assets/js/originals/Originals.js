async function Originals() {
    try {
        ...
        let originals = res.org.map(function(elem){
            return`
              <li>
              <div class="photo">
                <a href="#">
              ...
              <div class="text">
                ...
                <div class="svg">
                  <svg width="24px" height="17px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                    stroke="#bcb8b8">
                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round" stroke="#c9c9c9CCCCCC"
        ...
        document.querySelector("#org").insertAdjacentHTML("afterbegin",originals.join(""))
    } catch (error) {
        console.log(error.message);
    }
     var swiper = new Swiper(".interest", {
      slidesPerView: "auto",
      spaceBetween: 10,
      pagination: {
