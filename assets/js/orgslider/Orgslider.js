async function Orgslider() {
    try {
        let data = await fetch("https://aynazsafdari.github.io/jsonimdb/db.json")
        let res = await data.json()
        let orgslider = res.originalslider.map(function(elem){
            return`
        ...
        <div class="inn">
                 <div>
                  ...
                  <div class="text">
                    <a href="#" class="firstline">${elem.name}</a>
                    ...
                    <div class="svg">
                      <svg width="24px" height="17px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"
                          stroke="#c9c9c9CCCCCC" stroke-width="0.096"></g>
                        <g id="SVGRepo_iconCarrier">
                          <path
        ...
        document.querySelector("#os").insertAdjacentHTML("afterbegin",orgslider.join(""))
    } catch (error) {
        console.log(error.message);
    }
     var swiper = new Swiper(".ORG", {
      slidesPerView: 3,
      spaceBetween: 10,
      pagination: {
